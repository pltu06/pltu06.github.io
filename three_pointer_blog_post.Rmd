...
The plot revealed that there was a clear increase in three pointers made over the last twenty-one years in the NBA and we decided to perform a deeper analysis on the data.
